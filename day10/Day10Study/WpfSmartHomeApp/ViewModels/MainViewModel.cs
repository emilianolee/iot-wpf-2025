...
namespace WpfSmartHomeApp.ViewModels
{
    public partial class MainViewModel : ObservableObject, IDisposable
    {
        ...
        private Task MqttClient_ApplicationMessageReceivedAsync(MqttApplicationMessageReceivedEventArgs arg)
        {
            ...
            //Common.LOGGER.Info($@"Light : {data.L} / Rain : {data.R} / Temperature : {data.T} /  Humidity : {data.H} 
            //                      Fan : {data.F} / Vulnerabilty : {data.V} / RealLight : {data.RL} / ChaimBell : {data.CB} ");
            ...
            return Task.CompletedTask;  // 구독이 종료됨을 알려주는 return문
        }
