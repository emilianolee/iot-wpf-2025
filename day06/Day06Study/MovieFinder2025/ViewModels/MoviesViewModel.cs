...
namespace MovieFinder2025.ViewModels
{
    public partial class MoviesViewModel : ObservableObject
    {
        ...
        public async Task SearchMovie()
        {
            ...
            {
                await this.dialogCoordinator.ShowMessageAsync(this, "영화검색", "영화명을 입력하시오.");
                return;
            }

            var controller = await dialogCoordinator.ShowProgressAsync(this, "검색중", "Searching...");
        ...
        {
            string tmdb_apikey = "97b9e556812c17da8ecbecfcda94b781";    //TMDB에서 신청한 API 키
            ...
            //Task<MovieSearchResponse?> response; //HttpResponseMessage response;
            ...
            try
            {
                ...
                Common.LOGGER.Info($"'{movieName}' 검색 결과: {response.Total_results}건 검색됨");
        ...
        {
            //await this.dialogCoordinator.ShowMessageAsync(this, "즐겨찾기 보기", "즐겨찾기 확인합니다!");
            ObservableCollection<MovieItem> movieItems = new ObservableCollection<MovieItem>();
        ...
        {
            //await this.dialogCoordinator.ShowMessageAsync(this, "즐겨찾기 삭제", "즐겨찾기 삭제합니다!");
            if (SelectedMovieItem == null)
            {
            ...
            await ViewFavoriteMovies();   // 삭제 후 즐겨찾기 다시보기
        }
