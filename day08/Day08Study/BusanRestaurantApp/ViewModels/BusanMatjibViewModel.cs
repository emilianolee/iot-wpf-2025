...
namespace BusanRestaurantApp.ViewModels
{
    public partial class BusanMatjibViewModel : ObservableObject
    {
        ...
        public async Task MatjibItemDoubleClick()
        {
            ...
            viewModel.SelectedMatjibItem = SelectedMatjibItem;  // 메인창에 있는 선택 아이템을 그대로 구글맵쪽으로 전달
        ...
        private async Task GetDataFromApi()
        {
            ...
            string myServiceKey = "saYVBP0enloLFpRja3If30bmJgPZclXWkxhybGy8fAJ%2BFMva6TZH4IH1Q33O4UujRjm5VuFddhlpqif0sqr5cQ%3D%3D";
            // serviceKey = zmUY2JqiPqaZHmZ7VDke8wMFu3m%2FCXZSUCawmglK99g1cw5ytYYWZ%2F4VmiJz2Wn5MB1aBEA7N0YlXlJz%2B%2FK8A%3D%3D&pageNo=1&numOfRows=10&resultType=json
